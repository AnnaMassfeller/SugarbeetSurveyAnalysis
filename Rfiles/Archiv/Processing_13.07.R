...
FullSample$meanDist<- ifelse(FullSample$q5_alt_dist == 6,2000,FullSample$meanDist)#those who didn't observe any fields get 2000 as distance
...
FullSample$`FLC004_BNZAT-2132` <-ifelse(FullSample$CountyID == "03152",2900,FullSample$`FLC004_BNZAT-2132`)
FullSample$`FLC004_BNZAT-2132` <-ifelse(FullSample$CountyID == "06535",96,FullSample$`FLC004_BNZAT-2132`)
FullSample$`FLC004_BNZAT-2132` <-ifelse(FullSample$CountyID == "01003",102,FullSample$`FLC004_BNZAT-2132`)
FullSample$`FLC004_BNZAT-2132` <-ifelse(FullSample$CountyID == "06411",41,FullSample$`FLC004_BNZAT-2132`)
...
df.Soil_fieldlevel<-df.SoilSlope %>%
  group_by(date) %>%
  summarise_at(vars(slope_in_degrees:elevation_in_m), list(mean = mean))
...
d.full$shareSB_check <- d.full$`FLC004_BNZAT-2132`/d.full$`FLC004_BNZAT-21`
