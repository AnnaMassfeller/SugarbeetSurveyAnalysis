...
SampleIV <- apply_labels(SampleIV,q1_adopt="Adoption mechanical weeding binary",
                         ...
                         slope_in_degrees_mean="mean/ median slope at county or field level",
                         ...
                         sq.slope_in_degrees_mean="sq.mean/ median slope at county or field level",
                         ...
                         ShareSmallArea= "share of area of farms with <10 ha in total UAA",
